...
<head>
    ...
    <style>
        ...
        /* Tarjeta principal con 75% de transparencia (25% de opacidad) */
        .main-app-card {
             background-color: rgba(255, 255, 255, 0.75); /* Alpha 0.75 para 75% de transparencia */
...
<body class="p-4 md:p-8">
    ...
    <!-- FOOTER SOLICITADO -->
    <footer class="text-center text-sm text-gray-500 mt-8 pb-4 print-hidden">
        Elaborada por X. Real, P. Olivos y O. Bolaños, Agradecimiento especial a G. Maldonado.
    </footer>
